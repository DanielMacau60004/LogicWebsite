package algorithm.single.state;

import algorithm.single.ERule;
import algorithm.single.Solution;
import algorithm.single.transition.TransitionEdge;
import algorithm.single.transition.TransitionGraph;
import algorithm.single.transition.TransitionNode;
import ast.Exp;
...
public class StateGraph {
    ...
    public String toString() {
        ...
        str += "Closed: " + graph.keySet().stream().filter(StateNode::isClosed).count() + "\n";
