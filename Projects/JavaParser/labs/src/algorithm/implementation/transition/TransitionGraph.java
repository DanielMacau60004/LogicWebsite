package algorithm.implementation.transition;

import algorithm.ERule;
import algorithm.ExpUtils;
import ast.Exp;
import ast.logic.*;
...
public class TransitionGraph {
    ...
    private void absurdityRule(Exp exp) {
        ...
        addEdge(exp, new TransitionEdge(ERule.ELIM_NEGATION, ExpUtils.BOT, neg), true);
    ...
    private void biconditionalIRule(Exp exp, ASTBiconditional eq) {
        addEdge(exp, new TransitionEdge(ERule.INTRO_CONJUNCTION)
    ...
    private void biconditionalERule(Exp exp, ASTBiconditional eq) {
        addEdge(new ASTAnd(
