...
import logic.typechecker.errors.TypeErrorDuplicatedDeclaration;
import logic.typechecker.errors.TypeErrorExpression;
import logic.types.*;
...
public class FOLTypeChecker implements FOLVisitor<Type, Env<Type>> {
    ...
    @Override
    public Type visit(ASTFun astFun, Env<Type> env) {
