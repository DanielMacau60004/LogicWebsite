...
public class TransitionGraph {
    ...
    private void absurdityRule(Exp exp) {
        ...
        addEdge(exp, new TransitionEdge(ERule.ELIM_NEGATION, ExpUtils.BOT, null, neg, false), true);

        //if(transitions.containsKey(neg)) {
        addEdge(ExpUtils.BOT, new TransitionEdge(ERule.ABSURDITY)
                        .addTransition(exp, null, null, false)
                        .addTransition(neg, null, null, false)
                , false);
        //} else {
        //    addEdge(ExpUtils.BOT, new TransitionEdge(ERule.ABSURDITY, exp, neg, null, false), true);
        //}
    }
    ...
    private void implicationIRule(Exp exp, ASTImplication imp) {
        ...
        addEdge(exp, new TransitionEdge(ERule.INTRO_IMPLICATION, right, null, left, false), true);
    }

    private void negationIRule(Exp exp, ASTNot not) {
        Exp notNeg = ExpUtils.removeParenthesis(not.exp);

        addEdge(exp, new TransitionEdge(ERule.ELIM_NEGATION, ExpUtils.BOT, null, notNeg, false), true);
        //if(transitions.containsKey(notNeg)) {
        addEdge(ExpUtils.BOT, new TransitionEdge(ERule.ABSURDITY)
                        .addTransition(exp, null, null, false)
                        .addTransition(notNeg, null, null, false)
                , true);
        //} else {
        //    addEdge(ExpUtils.BOT, new TransitionEdge(ERule.INTRO_NEGATION, exp, notNeg, null, true), true);
       // }
    ...
    private void disjunctionIRule(Exp exp, ASTOr or) {
        ...
        addEdge(exp,
                new TransitionEdge(ERule.INTRO_DISJUNCTION_RIGHT, left, null, null, false), true);
        addEdge(exp,
                new TransitionEdge(ERule.INTRO_DISJUNCTION_LEFT, right, null, null, false), true);
    }
    ...
    private TransitionEdge disjunctionERule(Exp exp, ASTOr or) {
        ...
        return new TransitionEdge(ERule.ELIM_DISJUNCTION)
                .addTransition(exp, null, left, true)
                .addTransition(exp, null, right, true)
                .addTransition(orExp, null, null, false);
    }
    ...
    private void implicationERule(Exp exp, ASTImplication imp) {
        ...
        addEdge(right, new TransitionEdge(ERule.ELIM_IMPLICATION)
                .addTransition(left, null, null, false)
                .addTransition(exp, null, null, false), true);
    }
    ...
    private void conjunctionERule(Exp exp, ASTAnd and) {
        ...
        addEdge(left,
                new TransitionEdge(ERule.ELIM_CONJUNCTION_LEFT, exp, null, null, false), true);
        addEdge(right,
                new TransitionEdge(ERule.ELIM_CONJUNCTION_RIGHT, exp, null, null, false), true);
    }
    ...
    private void conjunctionIRule(Exp exp, ASTAnd and) {
        ...
        addEdge(exp, new TransitionEdge(ERule.INTRO_CONJUNCTION)
                        .addTransition(left, null, null, false)
                        .addTransition(right, null, null, false)
                , true);
    }
