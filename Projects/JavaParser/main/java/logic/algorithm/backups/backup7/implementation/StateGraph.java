...
public class StateGraph {
    ...
    private void build(int heightLimit, int nodesLimit) {
        ...
        explore.add(new StateNode(transitionGraph.getConclusion(), transitionGraph.premisses, 0));
    ...
    public boolean isSolvable() {
        StateNode node = new StateNode(transitionGraph.getConclusion(), transitionGraph.premisses, 0);
    ...
    public List<Solution> findSolutions(int limit, StateNode initState, Set<ERule> forbiddenRules) {
        ...
        StateNode defaultState = new StateNode(transitionGraph.getConclusion(), transitionGraph.premisses, 0);
        if(initState != null) {
